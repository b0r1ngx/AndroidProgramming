...
## Решение дополнительных вопросов(Указаний) Задачи 1. LinearLayout
...
## Решение дополнительных вопросов(Указаний) Задачи 2. ConstraintLayout
...
## Решение дополнительных вопросов(Указаний) Задачи 3. ConstraintLayout
* test
